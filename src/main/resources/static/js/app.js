...
function toUserMessage(data) {
    ...
    //红点
    let count = Number($("#alertCount").html());
    count = count + 1;
    $("#alertCount").html(count);

    //添加消息

    let htmlStr='<a class="dropdown-item" href="/chat/'+obj.data.fromUser+'">\n' +
        ...
        '                                            <h6 class="msg-name">'+obj.data.fromUser +
        '                                            </h6>\n' +
        '                                            <p class="msg-info">'+obj.data.data+'</p>\n' +
        '                                        </div>\n' +
        '                                    </div>\n' +
        '                                </a>'
